@echo off
::  $Id: wdays.bat 0.02 1996/09/10 00:00:02 tom Exp $
::
::  wdays.bat:  Uses `wdays.sed' for filtering `gcal %mon -Cdl7+ -H::: ...'
...
::
gcal %%mon -Cdl7+ -H::: %1 %2 %3 %4 %5 %6 %7 %8 %9 > $$$tmp
type $$$tmp | sed -f wdays.sed
del $$$tmp > NUL:
